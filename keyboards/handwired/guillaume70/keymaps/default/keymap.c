...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |----------------------------------------------------------------|
     * |Ctrl|Win |Alt | Space  | Space  |Alt| PSCR| FN|Ctrl|Lef|Dow|Rig |
     * `----------------------------------------------------------------'
     */
    [_BASE] = LAYOUT_65_ansi(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, MO(_FN),                 KC_SPC,            KC_SPC,    KC_RALT, MO(_FN), KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_FN] = LAYOUT_65_ansi(
        ...
        _______, _______, _______, _______,             _______,            _______,      KC_PSCR, _______, _______, KC_MS_L, KC_MS_D, KC_MS_R
    ),
};
